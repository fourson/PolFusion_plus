...
class Chuncked_Self_Attn_C(nn.Module):
    """
        in_channel -> in_channel
    """

    def __init__(self, in_channel, r=8, grid=(8, 8)):
        super(Chuncked_Self_Attn_C, self).__init__()

        self.self_attn_c = Self_Attn_C(in_channel, r=r)
        self.grid = grid
    ...
    def forward(self, x):
        ...
        output = self.self_attn_c(x_).reshape(N, self.grid[0], self.grid[1], C, chunk_size_H,
